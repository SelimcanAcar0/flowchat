import 'package:flowchat/pages/message/photoview/photoview_index.dart';
...
class PhotoImageView extends GetView<PhotoImageViewController> {
  ...
  AppBar _buildAppbar() {
    return AppBar(
      ...
      title: Text(
        'Photoview',
        style: TextStyle(color: AppColors.primaryText, fontSize: 16.sp, fontWeight: FontWeight.normal),
      ),
    );
  }
